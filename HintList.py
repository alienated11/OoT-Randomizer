...
conditional_always = {
    ...
    'Kak 3rd Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < world.gs_token_rewards[2],
    'Kak 4th Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < world.gs_token_rewards[3],
    'Kak 5th Gold Skulltula Reward': lambda world: tokens_required_by_settings(world) < world.gs_token_rewards[4],
}
...
hintTable = {
    ...
    'Large Magic Jar':                                          (["a vial of mojo", "a wizardly receptacle", "a sorcerous quaff"], "a Large Magic Jar", 'item'),
    ...
    'Kak 5th Gold Skulltula Reward':                                (["#50 bug badges# rewards", "#50 spider souls# yields", "#50 auriferous arachnids# lead to"], "slaying #50 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak 4th Gold Skulltula Reward':                                (["#40 bug badges# rewards", "#40 spider souls# yields", "#40 auriferous arachnids# lead to"], "slaying #40 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak 3rd Gold Skulltula Reward':                                (["#30 bug badges# rewards", "#30 spider souls# yields", "#30 auriferous arachnids# lead to"], "slaying #30 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    'Kak 2nd Gold Skulltula Reward':                                (["#20 bug badges# rewards", "#20 spider souls# yields", "#20 auriferous arachnids# lead to"], "slaying #20 Gold Skulltulas# reveals", ['overworld', 'sometimes']),
    ...
    'Kak 1st Gold Skulltula Reward':                                (["#10 bug badges# rewards", "#10 spider souls# yields", "#10 auriferous arachnids# lead to"], "slaying #10 Gold Skulltulas# reveals", 'exclude'),
