...
setting_infos = [
        ...
        disable        = {
            True : {
                ...
                'settings': ['starting_age', 'shuffle_interior_entrances', 'shuffle_grotto_entrances',
                             'shuffle_grotto_location', 'shuffle_grotto_req', 'shuffle_dungeon_entrances', 'shuffle_dungeon_bosses',
        ...
        disable        = {
            ...
            'glitched'  : {'settings' : ['allowed_tricks', 'shuffle_interior_entrances', 'shuffle_grotto_entrances',
                                      'shuffle_grotto_location', 'shuffle_grotto_req',
                                         'shuffle_dungeon_entrances', 'shuffle_dungeon_bosses', 'shuffle_overworld_entrances', 'owl_drops', 'warp_songs', 'decouple_entrances',
                                         'spawn_positions', 'mq_dungeons_mode', 'mq_dungeons_specific', 'mq_dungeons_count', 'dungeon_shortcuts', 'deadly_bonks', 
                                         'shuffle_freestanding_items', 'shuffle_pots_crates', 'shuffle_beehives', 'shuffle_silver_rupees',
    ...
    Checkbutton(
        name='easy_treasure_game',
        gui_text='Easy Treasure Chest Game',
        gui_tooltip='''\
            Makes the keys in Treasure Chest minigame always be in the left chests.
        ''',
        default=False,
        shared=True,
        gui_params={
